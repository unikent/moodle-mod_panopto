...
class restore_panopto_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('PANOPTOINDEX', '/mod/panopto/index.php?id=$1', 'course');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('panopto', 'add', 'view.php?id={course_module}', '{panopto}');
        $rules[] = new restore_log_rule('panopto', 'update', 'view.php?id={course_module}', '{panopto}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('panopto', 'view all', 'index.php?id={course}', null);
